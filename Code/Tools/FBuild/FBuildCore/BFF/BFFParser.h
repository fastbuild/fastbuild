...
private:
    ...
    bool StoreVariableString( const AString & name, const BFFToken * rhsString, const BFFToken * operatorToken, BFFStackFrame * frame, bool optional );
    bool StoreVariableArray( const AString & name, const BFFTokenRange & tokenRange, const BFFToken * operatorIter, BFFStackFrame * frame, bool optional );
    bool StoreVariableStruct( const AString & name, const BFFTokenRange & tokenRange, const BFFToken * operatorToken, BFFStackFrame * frame, bool optional );
    bool StoreVariableBool( const AString & name, bool value, BFFStackFrame * frame, bool optional );
    bool StoreVariableInt( const AString & name, int value, BFFStackFrame * frame, bool optional );
    bool StoreVariableToVariable( const AString & dstName, const BFFToken * rhsToken, const BFFToken * operatorToken, BFFStackFrame * dstFrame, bool optional );
