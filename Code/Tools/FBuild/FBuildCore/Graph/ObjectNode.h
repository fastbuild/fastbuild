...
public:
    ...
    public:
        ...
        bool IsUsingClangTimeTrace() const          { return ( ( m_Flags & FLAG_CLANG_TIME_TRACE ) != 0 ); }
        ...
        enum Flag : uint32_t
        {
            ...
            FLAG_CLANG_TIME_TRACE               = 0x8000000,
        };
    ...
    bool IsUsingClangTimeTrace() const      { return m_CompilerFlags.IsUsingClangTimeTrace(); }
    ...
    void GetTimeTraceJsonName( AString& jsonFileName ) const;
