...
REFLECT_NODE_BEGIN( ExecNode, Node, MetaName( "ExecOutput" ) + MetaFile() )
    REFLECT( m_ExecExecutable, MetaFile() )
    REFLECT( m_ExecInput, MetaOptional() + MetaFile() )
    REFLECT( m_ExecInputPath, MetaOptional() + MetaPath() )
    REFLECT( m_ExecInputPattern, MetaOptional() )
    REFLECT( m_ExecInputPathRecurse, MetaOptional() )
    REFLECT( m_ExecInputExcludePath, MetaOptional() + MetaPath() )
    REFLECT( m_ExecInputExcludedFiles, MetaOptional() + MetaFile( true ) )
    REFLECT( m_ExecInputExcludePattern, MetaOptional() + MetaFile( true ) )
    REFLECT( m_ExecArguments, MetaOptional() )
    REFLECT( m_ExecWorkingDir, MetaOptional() + MetaPath() )
    REFLECT( m_ExecReturnCode, MetaOptional() )
    REFLECT( m_ExecAlwaysShowOutput, MetaOptional() )
    REFLECT( m_ExecUseStdOutAsOutput, MetaOptional() )
    REFLECT( m_ExecAlways, MetaOptional() )
