...
REFLECT_STRUCT_BEGIN_BASE( XCodeProjectConfig )
    ...
    REFLECT( m_XCodeBaseSDK, MetaOptional() )
    REFLECT( m_XCodeDebugWorkingDir, MetaOptional() )
    REFLECT( m_XCodeIphoneOSDeploymentTarget, MetaOptional() )
...
REFLECT_NODE_BEGIN( XCodeProjectNode, Node, MetaName( "ProjectOutput" ) + MetaFile() )
    ...
    REFLECT( m_XCodeBuildWorkingDir, MetaOptional() )
    REFLECT( m_XCodeDocumentVersioning, MetaOptional() )
    REFLECT( m_XCodeCommandLineArguments, MetaOptional() )
    REFLECT( m_XCodeCommandLineArgumentsDisabled, MetaOptional() )
