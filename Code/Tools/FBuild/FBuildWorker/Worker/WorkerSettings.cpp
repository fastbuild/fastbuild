...
{
    m_WorkerSettingsNode->SetSandboxEnabled( sandboxEnabled );
}
...
{
    m_WorkerSettingsNode->SetSandboxExe( path );
}
...
{
    m_WorkerSettingsNode->SetSandboxArgs( args );
}
...
{
    m_WorkerSettingsNode->SetSandboxTmp( path );
}
...
{
    m_WorkerSettingsNode->ApplyWorkerTags( workerTags );
}
