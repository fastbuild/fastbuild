...
private:
    ...
    void Solution_ExternalProject() const;
    void Solution_ExternalProjectWrongData() const;
...
// Solution_ExternalProjectWrongData
//------------------------------------------------------------------------------
void TestProjectGeneration::Solution_ExternalProjectWrongData() const
{
